...
public class SearchQuestionServlet extends HttpServlet {
    static org.apache.log4j.Logger LOGGER = org.apache.log4j.Logger.getLogger(SearchQuestionServlet.class);
    private final String searchQuestion = "adminPage.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (search != null && search.length() > 0) {
                ...
                List<QuestionDTO> result = questionDAO.searchNameQuestion(search);          
            ...
            request.getRequestDispatcher(searchQuestion).forward(request, response);
            out.close();
        }
    }
