...
public class ShowQuestionServlet extends HttpServlet {
    static org.apache.log4j.Logger LOGGER = org.apache.log4j.Logger.getLogger(ShowQuestionServlet.class);
    private final String showQuestion = "adminPage.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (pageNumber == null) {
                listQuestion = dao.getQuestionPaging();
            } else {
                listQuestion = dao.getQuestionPaging(Integer.parseInt(pageNumber));
            }
            int totalQuestions = dao.countTotalQuestion();
            int page = (int) Math.ceil(totalQuestions / 5);
