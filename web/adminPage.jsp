...
<html>
    ...
    <body>
        ...
        <div class="mt-3 p-3 container card" style="width: 1200px">
            ...
            <form action="DispatcherController" method="GET">
                ...
                <input class="mr-2 btn btn-info" type="submit" value="Search" name="btAction"/>

            </form>
            <form action="DispatcherController" method="POST" class="mt-2">
                ...
                </select> <input class="mr-2 btn btn-info" type="submit" value="Search Subject" name="btAction"/>
            </form>
            ...
            <form action="DispatcherController" method="POST" class="mt-2">
                ...
                </select> <input class="mr-2 btn btn-info" type="submit" value="Search Status" name="btAction"/>
            </form>
